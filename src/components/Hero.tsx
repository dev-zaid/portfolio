    ...
    >
      ...
      <div className="absolute inset-x-0 inset-y-[-20%] flex items-center justify-center z-10 pointer-events-none overflow-hidden" id="hero-bg-text">
        ...
        >
          ...
          <span 
            className="text-[40vw] md:text-[350px] lg:text-[500px] font-sans font-bold tracking-tighter leading-none text-transparent select-none whitespace-nowrap opacity-20"
            style={{
